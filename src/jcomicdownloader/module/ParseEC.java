...
public class ParseEC extends ParseOnlineComicSite {
  ...
  //8comic的新解碼方式
  void decodePicUrl(String itemid, String allcodes, String chs, String chString) {
    ...
    if("".equals(code)) {
      code = subString(allcodes, allcodes.length() - 50, 50);
      cid = Integer.parseInt(chs);
    }
    Common.debugPrint( "開始解析這一集有幾頁 :\n" );
    totalPage = Integer.parseInt(subStringAndRemoveAlpha(code, 7, 3));
  ...
  String subStringAndRemoveAlpha(String str, int beginIndex, int len) {
    return subString(str, beginIndex, len).replaceAll("[A-Za-z]*", "");
  }

  String subString(String str, int beginIndex, int len) {
  ...
  public String getTitleOnMainPage( String urlString, String allPageString ) {
    ...
    System.out.printf("%d %d", beginIndex, endIndex);
